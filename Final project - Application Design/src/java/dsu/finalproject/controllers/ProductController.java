...
public class ProductController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
       operation2 = request.getParameter("operation");
        switch (operation2) {
            case "check available categories":
            ...
            case "categoria":
                ...
                listCategories2(request, response);
            default:
    ...
    public void listCategories2(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        List<Product> listcategories = new ArrayList<>();
        listcategories = new ProductService().getProductByCategory(request.getParameter("operation"));
        request.setAttribute("listcategories", listcategories);
        request.setAttribute("title", "List of products by Category");
        request.getRequestDispatcher("listOfProductsByCategory.jsp").forward(request, response);
